...
class ShopProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shop_profile" do
    assert_difference('ShopProfile.count') do
      post shop_profiles_url, params: { shop_profile: { address: @shop_profile.address, comment: @shop_profile.comment, description: @shop_profile.description, name: @shop_profile.name, pone: @shop_profile.pone, rating: @shop_profile.rating, user_id: @shop_profile.user_id } }
    end
  ...
  test "should update shop_profile" do
    patch shop_profile_url(@shop_profile), params: { shop_profile: { address: @shop_profile.address, comment: @shop_profile.comment, description: @shop_profile.description, name: @shop_profile.name, pone: @shop_profile.pone, rating: @shop_profile.rating, user_id: @shop_profile.user_id } }
